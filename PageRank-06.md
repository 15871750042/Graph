![截屏2023-02-25 下午5.33.15](https://p.ipic.vip/0f83zz.png)

![截屏2023-02-25 下午5.35.43](https://p.ipic.vip/0kx7wg.png)

### 1.互联网的图表示

![截屏2023-02-25 下午5.41.43](https://p.ipic.vip/i1dr1w.png)
...
![截屏2023-02-25 下午5.50.59](https://p.ipic.vip/gn7xur.png)

高斯消元法可以求解，但当节点数量较多的时候，计算相对复杂，可扩展性较差。![截屏2023-02-25 下午5.56.11](https://p.ipic.vip/mdif5p.png)
...
![截屏2023-02-25 下午5.58.17](https://p.ipic.vip/g87wme.png)

![截屏2023-02-25 下午5.59.30](https://p.ipic.vip/heh5tz.png)

![截屏2023-02-25 下午6.05.39](https://p.ipic.vip/hw8jr4.png)

#### 2.3矩阵的特征向量($O(n^3)$，不推荐)

![截屏2023-02-25 下午6.08.33](https://p.ipic.vip/mi4rtg.png)

![截屏2023-02-25 下午6.09.47](https://p.ipic.vip/vb2de5.png)

![截屏2023-02-25 下午6.11.13](https://p.ipic.vip/a6xtgo.png)

#### 2.4随机游走(需模拟很多游走，不推荐)

![截屏2023-02-25 下午6.13.26](https://p.ipic.vip/z4wui4.png)

![截屏2023-02-25 下午6.14.02](https://p.ipic.vip/wpmxin.png)
...
![截屏2023-02-25 下午6.22.17](https://p.ipic.vip/ghf8u4.png)

**求解流程：**

![截屏2023-02-25 下午6.22.43](https://p.ipic.vip/agpqeq.png)

### 4.pagerank收敛分析

![截屏2023-02-25 下午6.25.56](https://p.ipic.vip/26yb6o.png)

第一、二点同时满足才算是真正收敛。

![截屏2023-02-25 下午6.33.39](https://p.ipic.vip/tfk34o.png)

对于非孤立、非周期性的马尔科夫链（互联网满足），可以满足第一点。

针对第二点，存在下面两个问题：（没有出链接、仅指向自己）这两种即便能计算出pagerank值，也不是我们想要的结果。

![截屏2023-02-25 下午6.36.42](https://p.ipic.vip/fg8j8g.png)
...
![截屏2023-02-25 下午6.40.31](https://p.ipic.vip/9hkzf0.png)

**阻尼系数$\beta$**表示将一个网页跳转到原定网页的概率。**$1-\beta$的概率**，从一个网页**随机跳转**到其它网页，这样就能避免陷入到死胡同节点。（进入到某个节点就无法出来）

![截屏2023-02-25 下午6.41.53](https://p.ipic.vip/axmb48.png)

Dead-ends中数学上存在问题，这样会导致概率矩阵某些列元素的和为0，这种需要改写矩阵，使得概率矩阵每列元素的和都为1.![截屏2023-02-26 上午12.50.54](https://p.ipic.vip/r7c30l.png)

![截屏2023-02-25 下午6.43.23](https://p.ipic.vip/h3hdif.png)
...
![截屏2023-02-25 下午7.04.26](https://p.ipic.vip/vnief7.png)

![截屏2023-02-25 下午7.06.18](https://p.ipic.vip/q55t3t.png)

### 参考资料

![截屏2023-02-25 下午7.25.55](https://p.ipic.vip/na9ogt.png)

### 思考题

![截屏2023-02-26 上午12.52.51](https://p.ipic.vip/h4k1oq.png)
...
7. ##### PageRank、Personlized PageRank、 RandomWalk with Restart,这三种算法有什么区别？ （‼️）

PageRank是一种用于评估网页重要性的算法，它**基于网页间的链接结构，通过迭代计算网页之间的关联性来确定网页的排名。**

Personalized PageRank是一种基于PageRank算法的扩展，它允许用户对结果进行**个性化定制**。在Personalized PageRank中，除了考虑网页之间的链接关系，还会考虑用户对特定网页的兴趣程度，从而为用户提供更加个性化的结果。

Random Walk with Restart (RWR)也是一种基于图的算法，它通过模拟随机游走来确定节点的排名。与PageRank不同的是，RWR不仅考虑了节点之间的链接关系，还考虑了节点与图中其他节点的**距离关系**。在RWR中，**节点的排名是由所有其他节点通过随机游走到该节点的概率之和计算得出的**。
